...
namespace T39_04_04_SQLiteDirectoryUI_Homework
{
	// Build a simple database in SQLite that holds People, Addresses, and Employers.
	...
	internal class Program
	{
		...
		private static void PrintAllTables(SQLiteCrud sql)
		{
